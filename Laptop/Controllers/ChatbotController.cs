        ...
        */
        private async Task<string> GetChatbotResponseAsync(string userInput)
        {
            ...
            var keywordSynonyms = new Dictionary<string, List<string>>
            {
                ...
                { "lập trình", new List<string> { "lập trình", "dev", "code", "học lập trình", "laptop cho lập trình", "máy tính lập trình", "laptop cho dev", "laptop code", "lap trinh", "laptrinh", "devloper", "devlop", "lap-top", "lap top", "laptop lap trinh" } },
                ...
                { "bảo hành", new List<string> { "bảo hành", "thời gian bảo hành", "chính sách bảo hành" } },
                { "tính năng đặc biệt", new List<string> { "tính năng đặc biệt", "màn hình cảm ứng", "độ phân giải cao", "tính năng vượt trội" } },
                ...
                { "chi tiết sản phẩm", new List<string> { "chi tiết", "thông tin chi tiết", "cấu hình chi tiết", "thông số sản phẩm", "tìm hiểu sản phẩm", "xem chi tiết" } },
                ...
                { "trên 30 triệu", new List<string> { "trên 30 triệu", "dưới 30 triệu", "khoảng 30tr", "dưới 30tr" } },
            ...
            var responses = new Dictionary<string, Func<Task<string>>>
            {
                ...
                { "bảo hành", async () =>"Thông tin về thời gian bảo hành sản phẩm, bạn cần biết điều gì?" },

                { "khuyến mãi", async () =>"Bạn muốn biết về các chương trình khuyến mãi hiện tại?" },

                { "tính năng đặc biệt", async () =>"Bạn muốn tìm sản phẩm có tính năng đặc biệt gì? Ví dụ: màn hình cảm ứng, độ phân giải cao, hay các tính năng vượt trội khác?" },

                { "giao hàng", async () =>"Thời gian giao hàng có thể khác nhau tùy theo địa điểm của bạn. Bạn muốn biết thời gian giao hàng cho sản phẩm nào?" },
